...
def draw_16x16x128_a_c_annotated(path: Path):
    ...
    svg.text(ax_x + ax_w / 2, ax_y - 12, "4 scale bytes", "dim", "middle")
    ...
    svg.text(c_x + 0.5 * c_cell_w, c_y + c_h + 16, "col0", "tiny", "middle")
    svg.text(c_x + 1.5 * c_cell_w, c_y + c_h + 16, "col1", "tiny", "middle")
    svg.text(c_x + 14.5 * c_cell_w, c_y + c_h + 16, "col14", "tiny", "middle")
    svg.text(c_x + 15.5 * c_cell_w, c_y + c_h + 16, "col15", "tiny", "middle")
